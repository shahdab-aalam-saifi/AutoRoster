...
public class TeamControllerTest {
  ...
  private static final String TEAM_JSON =
      "{\"name\":\"Operation Intelligence\",\"maxWfrlAllowed\":1,\"groups\":[{\"name\":\"SMAPI\",\"maxWfrlAllowed\":2,\"members\":[{\"name\":\"Shahdab Aalam Saifi\",\"isInterested\":true,\"likes\":[0],\"dislikes\":[4]}]}]}";
  private static final String TEAM_JSON_WITHOUT_MEMBERS =
      "{\"name\":\"Operation Intelligence\",\"maxWfrlAllowed\":1,\"groups\":[{\"name\":\"SMAPI\",\"maxWfrlAllowed\":2}]}";
  private static final String TEAM_JSON_WITHOUT_GROUPS =
      "{\"name\":\"Operation Intelligence\",\"maxWfrlAllowed\":1}";
  ...
  public void addNewTeam_WhenTeamIsValidJson_ResponseCode200() {
    ResponseEntity<Collection> response =
        controller.add((Team) stringToJsonObject("{}", Team.class));
  ...
  public void addNewTeam_WhenTeamJsonWithoutMembers_ResponseCode200() {
    ResponseEntity<Collection> response =
        controller.add((Team) stringToJsonObject(TEAM_JSON_WITHOUT_MEMBERS, Team.class));
    assertEquals(HttpStatus.OK, response.getStatusCode());
  }
  ...
  public void addNewTeam_WhenTeamJson_ResponseCode200() {
    ResponseEntity<Collection> response =
        controller.add((Team) stringToJsonObject(TEAM_JSON, Team.class));
    assertEquals(HttpStatus.OK, response.getStatusCode());
  }
  ...
  public void updateTeam_WhenTeamIsAvailable_ResponseCode200() {
    ...
    response =
        controller.update(collection.getId(), (Team) stringToJsonObject(TEAM_JSON, Team.class));
  ...
  public void updateTeam_WhenTeamIsNotAvailable_ResponseCode404() {
    ResponseEntity<Collection> response =
        controller.update("T0001", (Team) stringToJsonObject(TEAM_JSON, Team.class));
