...
public class GroupControllerTest {
	...
	private static final String TEAM_JSON = "{\"name\":\"Team Json\",\"maxWfrlAllowed\":1,\"groups\":[{\"name\":\"SMAPI\",\"maxWfrlAllowed\":2,\"members\":[{\"name\":\"Shahdab Aalam Saifi\",\"isInterested\":true,\"likes\":[0],\"dislikes\":[4]}]}]}";
	private static final String TEAM_JSON_WITHOUT_GROUPS = "{\"name\":\"Team Json without groups\",\"maxWfrlAllowed\":1}";
