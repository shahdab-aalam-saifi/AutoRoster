...
public class TeamController {
	 ...
	 * @return
	 */
	@RequestMapping(method = { RequestMethod.POST, RequestMethod.PUT }, path = { URL_ADD_NEW_TEAM }, produces = {
	...
	public ResponseEntity<Collection> add(@RequestBody @Valid Team team) {
		...
		Collection collection = Collection.builder().id(Utils.getObjectId()).name(team.getName()).maxWfrlAllowed(team
	 ...
	 * @return
	 */
	@RequestMapping(method = { RequestMethod.POST }, path = { URL_UPDATE_TEAM_BY_ID }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	 ...
	 * @return
	 */
	@RequestMapping(method = { RequestMethod.GET }, path = { URL_GET_TEAM }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	 ...
	 */
	@RequestMapping(method = { RequestMethod.GET }, path = { URL_GET_TEAM }, produces = {
			MediaType.APPLICATION_JSON_VALUE }, params = { "id" })
