...
public class TeamController {
	 ...
	 * @return
	 */
	@PostMapping(path = { URL_ADD_NEW_TEAM }, produces = { MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<Collection> add(@RequestBody @Valid Team team) {
		identityService.assignId(team);

		Collection collection = Collection.builder().id(team.getId()).name(team.getName()).maxWfrlAllowed(team
				.getMaxWfrlAllowed()).groups(team.getGroups()).build();
	 ...
	 * @return
	 */
	@PostMapping(path = { URL_UPDATE_TEAM_BY_ID }, produces = { MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<Collection> update(@RequestParam(required = true, name = TEAM_ID) String id,
	 ...
	 * @return
	 */
	@GetMapping(path = { URL_GET_TEAM }, produces = { MediaType.APPLICATION_JSON_VALUE })
	 ...
	 * @return
	 */
	@GetMapping(path = { URL_GET_TEAM }, produces = { MediaType.APPLICATION_JSON_VALUE }, params = { TEAM_ID })
