...
public class GroupController {
  ...
  @PostMapping(
      ...
      params = {TEAM_ID})
  public ResponseEntity<List<Group>> add(
   ...
   */
  @PostMapping(
      path = {URL_UPDATE_GROUP_BY_ID},
      produces = {MediaType.APPLICATION_JSON_VALUE},
      params = {TEAM_ID, GROUP_ID})
  public ResponseEntity<List<Group>> update(
  ...
  @GetMapping(
      ...
      produces = {MediaType.APPLICATION_JSON_VALUE},
      params = {TEAM_ID})
  public ResponseEntity<List<Group>> getByTeamId(
      @RequestParam(required = true, name = TEAM_ID) String teamId) {
    Collection collection = repository.findById(teamId).orElse(null);
  ...
  @GetMapping(
      ...
      produces = {MediaType.APPLICATION_JSON_VALUE},
      params = {GROUP_ID})
  public ResponseEntity<Group> getByGroupId(
      @RequestParam(required = true, name = GROUP_ID) String groupId) {
    Collection collection = repository.findByGroupId(groupId).orElse(null);
